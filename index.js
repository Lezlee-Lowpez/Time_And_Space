...
// ANSWER:
// If the solution is just asking for a specific index we can just access the point instead of looping through the array and set it equal it one.
...
// no i don't believe so because we always need to put it into an array and that will always have to be pushed.
...
// ANSWER: 
// both functions are manipulating an object in sequential order. 
